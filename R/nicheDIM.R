...
#' @param scale.limit NOTE: scale.limit is not currently implemented in the code, and pairwise distances between resources are therefore scaled relative to the maximum distance across the entire pairwise distance matrix supplied
